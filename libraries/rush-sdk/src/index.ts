...
import { JsonFile, JsonObject, Import, IPackageJson, PackageJsonLookup, Executable } from '@rushstack/node-core-library';
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        const result: JsonObject = Executable.spawnSync("node", [installAndRunRushJSPath, "--help"], {
          stdio: 'inherit',
        });
